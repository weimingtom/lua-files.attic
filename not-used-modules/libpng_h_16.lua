--result of cpp png.h from libpng 1.6.0.b29 (and no longjmp stuff)
...
PNG_FORMAT_LINEAR_Y_ALPHA = 0x05,
PNG_FORMAT_LINEAR_RGB = 0x06,
PNG_FORMAT_LINEAR_RGB_ALPHA = 0x07,
PNG_FORMAT_RGB_COLORMAP = 0x0a,
PNG_FORMAT_BGR_COLORMAP = 0x1a,
PNG_FORMAT_RGBA_COLORMAP = 0x0b,
PNG_FORMAT_ARGB_COLORMAP = 0x2b,
PNG_FORMAT_BGRA_COLORMAP = 0x1b,
PNG_FORMAT_ABGR_COLORMAP = 0x3b,
}
...
typedef char* png_libpng_version_1_6_0beta29;
...
png_uint_32 png_get_hIST (png_const_structrp png_ptr, png_const_inforp info_ptr, png_uint_16p *hist);
...
png_uint_32 png_get_pCAL (png_const_structrp png_ptr, png_const_inforp info_ptr, png_charp *purpose, png_int_32 *X0, png_int_32 *X1, int *type, int *nparams, png_charp *units, png_charpp *params);
...
png_uint_32 png_get_PLTE (png_const_structrp png_ptr, png_const_inforp info_ptr, png_colorp *palette, int *num_palette);
...
png_uint_32 png_get_iCCP (png_const_structrp png_ptr, png_const_inforp info_ptr, png_charpp name, int *compression_type, png_bytepp profile, png_uint_32 *proflen);
...
png_uint_32 png_get_sPLT (png_const_structrp png_ptr, png_const_inforp info_ptr, png_sPLT_tpp entries);
void png_set_sPLT (png_const_structrp png_ptr, png_inforp info_ptr, png_const_sPLT_tp entries, int nentries);
png_uint_32 png_get_text (png_const_structrp png_ptr, png_const_inforp info_ptr, png_textp *text_ptr, int *num_text);
...
int png_get_unknown_chunks (png_const_structrp png_ptr, png_const_inforp info_ptr, png_unknown_chunkpp entries);
