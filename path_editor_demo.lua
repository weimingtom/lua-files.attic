...
local path = {
	...
	'rel_line', 100, 0,
	'rel_symm_curve', 50, 100, 100, 0,
	'rel_line_arc', 100, 0, 50, 30, 60,
	'arc', 850, 650, 50, 30, 60,
	'rect', 600, 120, -50, -100,
	'round_rect', 700, 120, -50, -100, -10,
	'circle', 850, 70, -50,
	'ellipse', 1000, 70, -50, -30, 20,
	...
	'move', 100, 750,
	'rel_arc_3p', 150, 0, 300, 0, --line
	'move', 100, 800,
	'rel_arc_3p', 300, 0, 150, 0, --negative line
	'superformula', 200, 500, 30, 100, 1, 1, 3, .5, .5, .5,
}
